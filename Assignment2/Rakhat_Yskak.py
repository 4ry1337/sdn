...
def topology():
    ...
    sta1 = net.addStation("sta1", ip="10.0.0.1/24", position="10,20,0", range=30)
    sta2 = net.addStation("sta2", ip="10.0.0.2/24", position="30,20,0", range=30)
    sta3 = net.addStation("sta3", ip="10.0.0.3/24", position="50,20,0", range=30)
